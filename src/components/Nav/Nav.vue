  ...
  >
    ...
    <Transition name="fade">
      <div
        ...
        class="flex select-none flex-col-reverse lg:flex-row justify-evenly lg:relative fixed bg-gray-200 transition-colors duration-500 dark:bg-fourth dark:lg:bg-transparent lg:bg-transparent w-3/4 lg:w-fit end-0 top-0 lg:h-auto h-screen lg:gap-10 items-center z-50 lg:items-center"
      >
